...
import com.example.ohukurorecipe.R
...
class SpeechService : Service() {
    ...
    @Volatile
    private var mAccessTokenTask: AccessTokenTask? =
        null
        ...
        if (mApi != null) {
            ...
            if (channel != null && !channel.isShutdown) {
                try {
                    ...
                    Log.e(
                        TAG,
                        "Error shutting down the gRPC channel.",
                        e
                    )
                }
            }
    ...
    private inner class AccessTokenTask :
        ...
        override fun doInBackground(vararg params: Void?): AccessToken? {
            ...
            val tokenValue =
                prefs.getString(PREF_ACCESS_TOKEN_VALUE, null)
            val expirationTime =
                prefs.getLong(PREF_ACCESS_TOKEN_EXPIRATION_TIME, -1)
            ...
            // *******************
            val stream = resources.openRawResource(R.raw.api_key)
            try {
    ...
    private class GoogleCredentialsInterceptor internal constructor(private val mCredentials: Credentials) :
        ...
        private var mLastMetadata: Map<String, List<String>>? =
            null
        ...
        private fun serviceUri(
            ...
            val defaultPort = 443
            val path =
                "/" + MethodDescriptor.extractFullServiceName(method.fullMethodName)
            var uri: URI
            uri = try {
    ...
    companion object {
        ...
        private const val PREF_ACCESS_TOKEN_EXPIRATION_TIME =
